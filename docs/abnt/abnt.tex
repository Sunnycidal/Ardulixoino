...
\instituicao{Centro Universitário Senac \par Análise e Desenvolvimento de Sistemas \par Disciplina: Conceitos de computação}
\autor{Altino Ávila \\ Guilherme Diniz \\ Samuel Teixeira\\ Jessiê Nascimento}
\titulo{Lixeira Automática utilizando Arduino Uno}
\preambulo{Tecnologia Frugal}
...
\begin{enumerate}
    ...
    \item Registrar eventos via Serial Monitor. (Arduino IDE)
\end{enumerate}
